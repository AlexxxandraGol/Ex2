...
LRESULT CALLBACK WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_PAINT:
		...
		case 0:
			...
			break;
		case 1:
			BitBlt(hdc, cx - 230, cy  - 150, bm.bmWidth, bm.bmHeight, memBit2, 0,0, SRCCOPY);
			break;
		case 2:
			BitBlt(hdc, cx - 330, cy - 210,  bm.bmWidth, bm.bmHeight, memBit1, 0,  0, SRCCOPY);
			break;
		case 3:
			BitBlt(hdc, cx - 500, cy - 260, bm.bmWidth, bm.bmHeight, memBit2,  0, 0, SRCCOPY);
			break;
		case 4:
			BitBlt(hdc, cx - 620, cy - 310, bm.bmWidth, bm.bmHeight, memBit1, 0,  0, SRCCOPY);
			break;
		case 5:
			BitBlt(hdc, cx - 730, cy - 360, bm.bmWidth, bm.bmHeight, memBit2,  0, 0, SRCCOPY);
			break;
		case 6:
			BitBlt(hdc, cx - 860, cy - 410,  bm.bmWidth, bm.bmHeight, memBit1, 0, 0, SRCCOPY);
			break;
		default:
			break;
		}
